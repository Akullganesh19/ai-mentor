...
export const siteConfig: SiteConfig = {
  ...templateSiteConfig,
  name: "Ai-Mentor",
  description: "Ai-Mentor documentation",
  repoUrl: "https://github.com/Akullganesh19/ai-mentor",
  links: [
    { label: "Get started", href: "/quickstart" },
    { label: "Support", href: "https://github.com/Akullganesh19/ai-mentor/issues/new" },
    { label: "GitHub", href: "https://github.com/Akullganesh19/ai-mentor" },
    { label: "Changelog", href: "/changelog" },
  ],
};
